...
SYSTEM_PROMPT = (
    ...
    "de la question).\n"
    "5. OBLIGATION ABSOLUE DE LANGUE : Votre réponse DOIT être écrite dans la "
    "MÊME LANGUE que la question posée. C'est NON NÉGOCIABLE.\n"
    "   • Question en ARABE → Réponse en ARABE (100% du texte)\n"
    "   • Question en FRANÇAIS → Réponse en FRANÇAIS (100% du texte)\n"
    "   • Question en ANGLAIS → Réponse en ANGLAIS (100% du texte)\n"
    "   La langue des documents sources NE change RIEN. Seule la langue de la "
    "question détermine la langue de votre réponse. Si la question est en arabe "
    "et le contexte en français, vous écrivez EN ARABE. Pas de mélange de langues.\n"
